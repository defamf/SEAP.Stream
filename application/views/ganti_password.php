              ...
              <div class="card-body">
                <form method="POST" action="<?= base_url('auth/ganti_password_aksi'); ?>">
                  <div class="form-group">
                    ...
                    <?= form_error('pass_baru', '<span class="text-small text-danger">', '</span>') ?>
                  </div>

                  <div class="form-group">
                    <label for="ulang_pass">Ulangi Password</label>
                    <input id="ulang_pass" type="password" class="form-control" name="ulang_pass" tabindex="1">
                    <?= form_error('ulang_pass', '<span class="text-small text-danger">', '</span>') ?>
                  </div>
