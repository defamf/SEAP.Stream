...
<head>
  ...
  <script src="<?= base_url('ckeditor'); ?>/ckeditor.js"></script>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/assets_stisla/'); ?>assets/modules/datatables/datatables.min.css">
  <link rel="stylesheet" href="<?= base_url('assets/assets_stisla/'); ?>assets/modules/datatables/DataTables-1.10.16/css/dataTables.bootstrap4.min.css">
  <link rel="stylesheet" href="<?= base_url('assets/assets_stisla/'); ?>assets/modules/datatables/Select-1.2.4/css/select.bootstrap4.min.css">
